...
## REQUIRES SUPERSHAPES PLUGIN: https://www.unrealengine.com/marketplace/supershapes
...
### If performance is an issue use the "SuperShapeMesh" component to avoid having to use transparancies 
![MeshCutout](/assets/MeshCutout.png)
